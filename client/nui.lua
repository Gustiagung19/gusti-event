...
TriggerServerEvent("gusti-event")
local claimed = 0
local rechnen = 0
RegisterNetEvent("gusti-event:Return")
AddEventHandler("gusti-event:Return", function(_claimed, _daytoday)
    claimed = _claimed
    rechnen = _daytoday
...
AddEventHandler("playerSpawned", function()
  TriggerServerEvent('gusti-event')
  TriggerServerEvent('gusti-event:Return')
end)
...
RegisterNUICallback("i1", function(data)
    SetDisplay(false)
    TriggerServerEvent("gusti-event:validateclaim")
end)
